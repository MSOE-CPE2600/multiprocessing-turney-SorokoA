...
```
<img width="715" height="430" alt="image" src="https://github.com/user-attachments/assets/9ad9145d-2600-45ae-8e7f-86206165cfe8" />
```
# Results:
```
This graph shows the results of running the program with the same settings each time, just a different number of processors each time ranging from 1 - 20 processors. It shows that adding more processors usually increased the speed up until a certain point where the difference in time won't be guarenteed to be faster than lesser number of processors.
```
